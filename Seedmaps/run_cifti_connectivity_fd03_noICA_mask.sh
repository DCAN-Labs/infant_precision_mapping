...
--additional-mask /home/miran045/shared/projects/WashU_Nordic/reliability_maps/reliability_curve_pconn/repeating_curves/masks/masksC1/maskC_half1_${MIN}min.txt \

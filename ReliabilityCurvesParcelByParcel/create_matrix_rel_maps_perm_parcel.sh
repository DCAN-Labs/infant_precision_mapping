...
mkdir /home/miran045/shared/projects/WashU_Nordic/reliability_maps/matrices_map_perm_parcel/;
cp ${work_dir}/matrix_rel_val_parcel_ses-${SES}_${MIN}min_${MNUM}perm.csv /home/miran045/shared/projects/WashU_Nordic/reliability_maps/matrices_map_perm_parcel/

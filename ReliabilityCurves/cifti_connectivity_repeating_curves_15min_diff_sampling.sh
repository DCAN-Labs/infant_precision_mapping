...
for k in {93..100}; 
do for n in {16..40}; do python3 /home/faird/shared/code/internal/utilities/cifti_connectivity/cifti_conn_wrapper.py \
...
--wb-command /home/faird/shared/code/external/utilities/workbench/1.4.2/workbench/bin_rh_linux64/wb_command --fd-threshold 0.3 --minutes 15 \
...
1.761 /home/miran045/shared/projects/WashU_Nordic/reliability_maps/reliability_curve_pconn/repeating_curves/half1/${n}min matrix; done

for n in {16..40}; do python3 /home/faird/shared/code/internal/utilities/cifti_connectivity/cifti_conn_wrapper.py \
...
matlab -r "addpath('/home/miran045/shared/projects/WashU_Nordic/code'); script_reliability_curve_repetition_test15min(${k})";

cd /home/miran045/shared/projects/WashU_Nordic/reliability_maps/reliability_curve_pconn/repeating_curves/half1/;
rm -R *; 
done;

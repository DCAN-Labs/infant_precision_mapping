...
#SBATCH --mail-user=koira019@umn.edu
#SBATCH -p msismall
...
s3cmd sync ${work_dir}/alldata/* ${BUCKET}/alldata/
s3cmd sync ${work_dir}/groundtruth/* ${BUCKET}/groundtruth/
s3cmd sync ${work_dir}/masks/* ${BUCKET}/masks/
